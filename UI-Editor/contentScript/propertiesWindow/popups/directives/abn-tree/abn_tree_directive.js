...
module.directive('abnTree', ['$timeout', function($timeout) {
  return {
    restrict: 'E',
    templateUrl: '../contentScript/propertiesWindow/popups/directives/abn-tree/abn_tree_template.html',
    scope: {
      treeData: '=',
      onSelect: '&',
      initialSelection: '='
    ...
    link: function(scope, element, attrs) {
      ...
      select_branch = function(branch, path) {
		  ...
		  if (path) {
			path = "" + path;
		  	for_each_branch(function(b) {
				if (b.getKey != null && path.indexOf(b.getKey()) == 0)	
			  		b.expanded = true;
			});
		  }
      ...
      if (attrs.initialSelection != null) {
        for_each_branch(function(b) {
            if (b.match != null && b.getKey != null) {
              if (b.match(attrs.initialSelection)) {
				//console.log("Initial Selection: " + b);
				return select_branch(b, b.getKey());
              }
	  ...
	  scope.$watch('initialSelection', function(key) {
          for_each_branch(function(b) {
            if (b.match != null && b.getKey != null) {
              if (b.match(key)) {
				//console.log("Initial Selection: " + b);
